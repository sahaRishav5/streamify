...
import { getLanguageFlag, capitialize } from "../lib/utils";
import {
  UsersIcon,
  UserPlusIcon,
  CheckCircleIcon,
...
const HomePage = () => {
  ...
  useEffect(() => {
    if (friendRequests?.incomingReqs?.length) {
  ...
  // console.log("incomings are...",friendRequests);
  console.log("Incoming Request IDs:", [...incomingRequestIds]);
          ...
          {loadingUsers ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {recommendedUsers.map((user) => {
                ...
                const haveTheySentReq = incomingRequestIds.has(user._id);
                  ...
                  >
                    <div className="card-body p-5 space-y-4">
                      ...
                      <button
                        ...
                        disabled={
                          hasRequestBeenSent || haveTheySentReq || isPending
                        }
                      >
                        {hasRequestBeenSent ? (
                          <>
                          ...
                          <>
                            <CheckCircleIcon className="size-4 mr-2" />
                            {user.fullName.split(" ")[0]} sent you a request
                          </>
                        ) : (
                          <>
